...
| Watch paths | `/apps/marketing/**`, `/docs/screenshots/**`, `/packages/site-analytics/**`, `/packages/typescript-config/**`, `/pnpm-workspace.yaml`, `/package.json`, `/pnpm-lock.yaml`, `/.dockerignore` |

...
- **Appearance:** color palette, System/Light/Dark appearance, preview/save/cancel,
  response style, activity details, and dashboard visibility. Search includes
  theme names (including Rosé Pine and rose pine), palette variants, and actions. The

...
export const settingsEntries = [
  {
    ...
    group: "appearance",
    terms:
      "Color theme palette Default Rosé Pine rose pine Dawn Main Carbonfox adapted light Catppuccin Latte Mocha System Light Dark device preview save cancel browser",
  },
  {
    id: "conversation",
    group: "appearance",

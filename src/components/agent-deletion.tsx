        ...
        <SheetContent finalFocus={trigger}>
          <div {...stylex.props(styles.confirmation)}>
            ...
            <SheetDescription>
              ...
              Notes, automations, dashboards, file records and coding job
              records from Roost. Queued agent turns will be discarded. This
              cannot be undone.
            </SheetDescription>
            <p>
            ...
            <p>
              ...
              stopped, and worker queues must be settled before deletion. Work
              already shared with other agents stays in their conversations.
            </p>
            {error && (
